...
@pytest.mark.parametrize("name,login,email,website,mobile,land_line,address,zip1,city,region,password,confirm_password", excelReader.get_data("../ExcelFiles/login_data.xlsx", "invalidPassword"))
...
class TestPasswordRegister:
    ...
    def test_invalid_password_register(self,name,login,email,website,mobile,land_line,address,zip1,city,region,password,confirm_password):
        ...
        log.info("Verification is done for password field")
