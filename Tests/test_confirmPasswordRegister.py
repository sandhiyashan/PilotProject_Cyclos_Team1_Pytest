...
@pytest.mark.parametrize("name,login,email,website,mobile,land_line,address,zip1,city,region,password,confirm_password", excelReader.get_data("../ExcelFiles/login_data.xlsx", "confirmPassword"))
