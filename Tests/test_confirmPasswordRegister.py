...
@pytest.mark.parametrize("name,login,email,website,mobile,land_line,address,zip1,city,region,password,confirm_password", excelReader.get_data("E:\PilotProject_Cyclos_Team1_Pytest-1\ExcelFiles\login_data.xlsx", "confirmPassword"))

class TestConfirmPasswordRegister:
    def test_confirm_password_register(self,name,login,email,website,mobile,land_line,address,zip1,city,region,password,confirm_password):
        ...
        register.verify_confirm_password()
        log.info("Verification is done by confirm password")
