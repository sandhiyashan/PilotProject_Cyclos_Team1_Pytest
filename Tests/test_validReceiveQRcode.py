...
@pytest.mark.parametrize("amount,description,username,password", excelReader.get_data("I:\\PilotProject_Cyclos_Team1_Pytest\\ExcelFiles\\qrcode.xlsx", "valid_data"))
